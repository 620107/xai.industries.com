  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body className={`${inter.variable} ${jetbrains.variable} font-sans antialiased overflow-x-hidden`}>
        ...
        <Analytics />
      {/* v0 – built-with badge */}
  <div dangerouslySetInnerHTML={{ __html: `<div id="v0-built-with-button-90207b0b-3cd6-40ba-8126-6de2bbff724b" style="
...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/b_NfZgu8CoXjn?ref=16GV1Y"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-90207b0b-3cd6-40ba-8126-6de2bbff724b').style.display='none'"
